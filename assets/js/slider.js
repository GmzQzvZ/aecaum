...
////////////////////////////////////////////////////
	...
	const brand_slider = new Swiper('.tv-brand-slider-active', {
		...
		navigation: {
			prevEl: '.tv-blog-area .arrow-prev',
			nextEl: '.tv-blog-area .arrow-next',
		},
		breakpoints: {
			'1400': {
				slidesPerView: 5,
	...
	const networkPrevBtn = document.querySelector('.tv-blog-area .arrow-prev');
	const networkNextBtn = document.querySelector('.tv-blog-area .arrow-next');

	if (networkPrevBtn) {
		networkPrevBtn.addEventListener('click', function () {
			brand_slider.slidePrev();
		});
	}

	if (networkNextBtn) {
		networkNextBtn.addEventListener('click', function () {
			brand_slider.slideNext();
		});
	}
...
const teamswiper = new Swiper('.tv-team-slide-active', {
    ...
    navigation: {
        prevEl: '.tv-team-right-area .arrow-prev',
        nextEl: '.tv-team-right-area .arrow-next',
    },
...
const teamPrevBtn = document.querySelector('.tv-team-right-area .arrow-prev');
const teamNextBtn = document.querySelector('.tv-team-right-area .arrow-next');
